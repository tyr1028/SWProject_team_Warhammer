...
p2.ft1.agents[0].create_weapon("Fists", "Ranged")
p2.ft1.agents[0].weapons[3].set_stats(4, 3, 3, 4)

p2.ft1.create_agent("Warrior2")
p2.ft1.agents[1].set_stats(3,3,1,3,3,13)
p2.ft1.agents[1].set_stats(3,3,1,3,3,13)
p2.ft1.agents[1].create_weapon("Auto bolt rifle", "Ranged")
p2.ft1.agents[1].weapons[0].set_stats(4, 3, 3, 4)
p2.ft1.agents[1].create_weapon("Bolt rifle", "Ranged")
p2.ft1.agents[1].weapons[1].set_stats(4, 3, 3, 4)
p2.ft1.agents[1].create_weapon("Stalker bolt rifle", "Ranged")
p2.ft1.agents[1].weapons[2].set_stats(4, 3, 3, 4)
p2.ft1.agents[1].create_weapon("Fists", "Ranged")
p2.ft1.agents[1].weapons[3].set_stats(4, 3, 3, 4)


p1.ft1.display_agents("Player 1")
p2.ft1.display_agents("Player 2")
